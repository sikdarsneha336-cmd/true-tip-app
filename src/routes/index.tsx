...
function ReportFlow({ step, draft, selectedCategory, formError, geoMessage, isSubmitting, canAdvance, onBack, onNext, onUpdate, onGps, onSubmit }: { step: Step; draft: ReportDraft; selectedCategory?: (typeof categories)[number] | undefined; formError: string; geoMessage: string; isSubmitting: boolean; canAdvance: boolean; onBack: () => void; onNext: () => void; onUpdate: <K extends keyof ReportDraft>(key: K, value: ReportDraft[K]) => void; onGps: () => void; onSubmit: () => void }) {
